...
| P04 | Konsistente Offline-Versionen und begrenztes Caching | A3, B3, B4 | In Arbeit | P01 | Branch `p04-konsistente-offline-versionen`; PR-Link wird nach Erstellung ergänzt |
...
- **Status:** In Arbeit
- **PR / Merge-Commit:** Branch `p04-konsistente-offline-versionen`; PR-Link wird nach Erstellung, Merge-Commit nach dem Merge ergänzt.
