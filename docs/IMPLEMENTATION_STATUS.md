...
| P19 | Suche und Menü neu gestalten (Material 3 Expressive) | Platzbedarf, Menüstruktur | In Arbeit | P05, P11, P14 | Eigener Branch `codex/p19-suche-menue`; PR-Link folgt, noch nicht gemergt |
...
- **PR / Merge-Commit:** Eigener Branch `codex/p19-suche-menue`; PR-Link wird nach Erstellung ergänzt. Noch kein Merge-Commit.
