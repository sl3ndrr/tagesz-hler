...
| P07 | Datenrettung und verständliche Speicherzustände | A6, A8 | In Arbeit | P02, P06 | Branch `p07-datenrettung-speicherzustaende`; PR-Link wird nach Eröffnung ergänzt |
...
- **Status:** In Arbeit
- **PR / Merge-Commit:** Branch `p07-datenrettung-speicherzustaende`; PR-Link wird nach Eröffnung ergänzt. Merge-Commit und Status `Gemergt` werden ausschließlich nach tatsächlichem Merge ergänzt.
