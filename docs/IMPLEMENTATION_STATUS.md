...
| P09 | Installationsbezogene Speicherung und Präferenzen | B2, B17 | In Arbeit | P02, P04, P07 | Branch `p09-installationsbezogene-speicherung-praeferenzen`; PR-Link nach Erstellung, Merge-Commit nach Merge |
...
- **Status:** In Arbeit
- **PR / Merge-Commit:** Branch `p09-installationsbezogene-speicherung-praeferenzen`; PR-Link nach Erstellung. Merge-Commit und `Gemergt` erst nach tatsächlichem Merge.
